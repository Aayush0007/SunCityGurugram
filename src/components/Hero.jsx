        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-xl leading-relaxed">
              Experience expansive 3 & 4 BHK residences starting at ₹16,000/sq. ft. 
              Featuring a 1.5 Lakh sq. ft. Clubhouse and India's finest sports infrastructure.
            </p>
          ...
          >
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-2">Priority Access</h3>
              <p className="text-slate-500 text-sm mb-8">Register now to receive the brochure, floor plans, and pre-launch pricing.</p>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-4">
                ...
                <p className="text-[11px] text-slate-400 leading-tight">
                  <span className="text-emerald-600 font-bold">140+ People</span> registered for <br /> site visits this week.
                </p>
              </div>

              <div className="mt-6 flex items-center justify-center gap-2 text-[10px] text-slate-400 uppercase tracking-widest font-bold">
                <ShieldCheck className="w-4 h-4 text-emerald-500" /> RERA Registered Project
              </div>
            </div>
            ...
            <div className="absolute -bottom-6 -right-6 bg-amber-400 text-slate-900 p-4 rounded-2xl shadow-xl font-bold text-center rotate-3 hidden md:block">
              <p className="text-[10px] uppercase tracking-tighter">Limited Period</p>

...
export default function LeadPopup({ trigger = false, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = `Hi, I am interested in the Luxury Residential Portfolio on livingluxura.com.%0A%0A*Contact Details:*%0A- Name: ${formData.name}%0A- Mobile: ${validPhone}%0A- Current Location: ${formData.location}%0A%0A*Project Interest:*%0A- Suncity Monarch (Sector 78)%0A- Emaar Serenity Hills (Sector 86)%0A- Conscient Elaira / Ashiana Aaroham (Sector 80)%0A%0APlease share the master brochure, price list, and details regarding the new launch benefits.`;
